  ...
  return (
    <div className={styles.home}>
      ...
      <main>
        ...
        <p className={styles.text}> IntrovertsDAO is a non-profit decentralized autonomous organization that seeks to build and support a community of introverted people and helping everyone to achived is goal.
